      ...
      <div class="container h-100">
        <div class="row justify-content-center align-items-center h-100">
          <div class="col-lg-8">
            ...
            <h1 class="fg-white text-center">Inscripción</h1>
          </div>
        </div>
      </div>
    </div> <!-- .page-banner -->
    ...
    <div class="page-section">
      <div class="container">
        <div class="text-center">
          <h2 class="title-section mb-3 text-primary">Inscribite</h2>
          <p>Formá parate del Polo Tecnológico La Costa y disfrutá de importantes beneficios </p>
        </div>
          ...
          <div class="col-lg-8">
            <form action="#" class="form-contact">
              <div class="row">
                ...
                <div class="col-sm-6 py-2">
                  <label for="name" class="fg-grey">Motivo</label>
                  <input type="text" class="form-control" id="name" placeholder="Motivo..">
                </div>
                <div class="col-sm-6 py-2">
                  <label for="email" class="fg-grey">Teléfono</label>
                  <input type="text" class="form-control" id="email" placeholder="Telefono ...">
                </div>
                <div class="col-12 py-2">
                  <label for="subject" class="fg-grey">Razón social</label>
                  <input type="text" class="form-control" id="subject" placeholder="Nombre de la empresa..">
                </div>
                <div class="col-12 py-2">
                  <label for="message" class="fg-grey">Mensaje</label>
                  <textarea id="message" rows="8" class="form-control" placeholder="Ingrese su mensaje.."></textarea>
                </div>
