      ...
      <div class="container h-100">
        <div class="row justify-content-center align-items-center h-100">
          <div class="col-lg-8">
            ...
            <h1 class="fg-white text-center">Contacto</h1>
          </div>
        </div>
      </div>
    </div> <!-- .page-banner -->
    ...
    <div class="page-section">
      <div class="container">
        <div class="text-center">
          <h2 class="title-section mb-3 text-primary">Contactanos</h2>
          <p>Ponete en contacto con nosotros te responderemos a la brevedad <a href="mailto:example@mail.com">example@mail.com</a></p>
        </div>
            ...
            <form action="#" class="form-contact">
              <div class="row">
                ...
                <div class="col-12 py-2">
                  <label for="subject" class="fg-grey">Motivo</label>
